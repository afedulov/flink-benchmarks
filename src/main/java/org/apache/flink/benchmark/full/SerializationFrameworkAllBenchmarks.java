...
public class SerializationFrameworkAllBenchmarks extends SerializationFrameworkMiniBenchmarks {
	...
	public void serializerKryoThriftWithoutRegistration() throws Exception {
		LocalStreamEnvironment env =
				StreamExecutionEnvironment.createLocalEnvironment(4);
		ExecutionConfig executionConfig = env.getConfig();
		executionConfig.enableForceKryo();
		env.getConfig().addDefaultKryoSerializer(org.apache.flink.benchmark.avro.MyPojo.class, TBaseSerializer.class);
		env.getConfig().addDefaultKryoSerializer(org.apache.flink.benchmark.avro.MyOperation.class, TBaseSerializer.class);
	...
	@Benchmark
	@OperationsPerInvocation(value = SerializationFrameworkMiniBenchmarks.RECORDS_PER_INVOCATION)
	public void serializerKryoThrift() throws Exception {
		LocalStreamEnvironment env =
				StreamExecutionEnvironment.createLocalEnvironment(4);
		ExecutionConfig executionConfig = env.getConfig();
		executionConfig.enableForceKryo();
		env.getConfig().registerKryoType(org.apache.flink.benchmark.avro.MyPojo.class);
		env.getConfig().registerKryoType(org.apache.flink.benchmark.avro.MyOperation.class);
		env.getConfig().addDefaultKryoSerializer(org.apache.flink.benchmark.avro.MyPojo.class, TBaseSerializer.class);
		env.getConfig().addDefaultKryoSerializer(org.apache.flink.benchmark.avro.MyOperation.class, TBaseSerializer.class);
	...
	@Benchmark
	@OperationsPerInvocation(value = SerializationFrameworkMiniBenchmarks.RECORDS_PER_INVOCATION)
	public void serializerKryoProtobuf() throws Exception {
		LocalStreamEnvironment env =
				StreamExecutionEnvironment.createLocalEnvironment(4);
		ExecutionConfig executionConfig = env.getConfig();
		executionConfig.enableForceKryo();
		env.getConfig().registerTypeWithKryoSerializer(org.apache.flink.benchmark.protobuf.MyPojoOuterClass.MyPojo.class, ProtobufSerializer.class);
		env.getConfig().registerTypeWithKryoSerializer(org.apache.flink.benchmark.protobuf.MyPojoOuterClass.MyOperation.class, ProtobufSerializer.class);
